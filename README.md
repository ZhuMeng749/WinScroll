...
在 **[版本下载页面](https://github.com/ZhuMeng749/WinScroll/releases/tag/v1.0.0)** 下载 `WinScroll-1.0.0-macOS-arm64.zip`，解压后即可获得应用，无需自己编译。Intel Mac 暂未提供预编译包。

当前版本是 **1.0.0 预览版**，已完成编译与 17 项事件逻辑检查，真实设备兼容性仍需要更多反馈。
